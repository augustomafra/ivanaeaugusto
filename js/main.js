;(function () {
	...
	var decodeId = function() {
		...
		if ("c29sdGVpcmVz" === id || "b3NjYXNhZGVz" === id) {
			const galeria = document.getElementById("fh5co-gallery-list");
			if (galeria) {
				for (var i = 0; i < galeria.children.length; i++) {
					galeria.children[i].children[0].href = "presente" + (i + 1) + ".html?id=" + id;
				}
			}
		}
